...
/*
  marshal.c from 1.6.8 adapted for 1.8.0
*/
...
Init_marshal16()
{
    ...
    rb_define_module_function(rb_mMarshal, "dump16", marshal_dump, -1);
    rb_define_module_function(rb_mMarshal, "load16", marshal_load, -1);
    rb_define_module_function(rb_mMarshal, "restore16", marshal_load, -1);
}
